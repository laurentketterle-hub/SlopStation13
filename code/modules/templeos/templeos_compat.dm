...
/datum/templeos_compat
	...
	var/static/list/templeos_wisdom = list(
		...
		"The elephant in the room is that the CIA niggers glow in the dark.",
...
/datum/emote/living/templeos_pray/run_emote(mob/user, params)
	...
	if(.)
		user.visible_message(
			span_notice("[user] chants: 𒀭𒈹 𒅆𒂍𒀀 (Inanna, look upon me!)"),
			span_notice("You feel the presence of the ancient gods."))
		playsound(user, 'sound/effects/pray.ogg', 50, TRUE)

// Priest role for TempleOS
/datum/job/priest_templeos
	title = "TempleOS Priest"
	flag = PRIEST_TEMPLEOS
	department_flag = CIVILIAN
	faction = "Station"
	total_positions = 1
	spawn_positions = 1
	supervisors = "God and Terry A. Davis"
	selection_color = "#dddd00"
	
/obj/item/clothing/suit/templeos_robe
	name = "TempleOS Priest Robes"
	desc = "Holy robes blessed by the spirit of HolyC. 640x480 threads of pure faith."
	icon_state = "chaplain_robe"
	item_state = "chaplain_robe"
	body_parts_covered = CHEST|ARMS|LEGS

// TempleOS announcement verb
/proc/templeos_broadcast_greeting()
	var/message = pick(global.templeos.sumerian_greetings)
	priority_announce(
		"𒋰𒁀𒀀𒋾 (Welcome!) — [message] — TempleOS players: you are seen and valued.",
		"TempleOS Compatability",
